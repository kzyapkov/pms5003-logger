...
cmd_domoticz_parser.add_argument(
        "--pm_1_percent_idx",
        help="IDX of PM1 percent - if empty nothing will be reported to domoticz")		
cmd_domoticz_parser.add_argument(
        "--pm_25_percent_idx",
        help="IDX of PM2.5 percent - if empty nothing will be reported to domoticz")	
cmd_domoticz_parser.add_argument(
        "--pm_10_percent_idx",
        help="IDX of PM10 percent - if empty nothing will be reported to domoticz")		
